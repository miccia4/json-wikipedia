...
public class ArticleParser {
    ...
    protected void parse(Article article, ParsedPage page) {
	article.setLang(lang);
	this.setWikiTitle(article);
	if (page == null) {
	    logger.warn("page is null for article {}", article.getTitle());
	} else {
	    this.setLinks(article, page);
	    this.setParagraphs(article, page);
	    // setShortDescription(article);
	    this.setTemplates(article, page);
	    this.setCategories(article, page);
	    this.setHighlights(article, page);
	    this.setSections(article, page);
	    this.setTables(article, page);
	    this.setEnWikiTitle(article, page);
	    this.setLists(article, page);
	}
	this.setRedirect(article);
	this.setDisambiguation(article);
	this.setIsList(article);
	System.out.println(article.getWikiTitle());
    }
     ...
     * @param page
     */
    protected void setRedirect(Article article, String mediawiki) {
	for (final String redirect : redirects) {
    ...
    protected void setParagraphs(Article article, ParsedPage page) {
     ...
     */
    protected void updateLinks(Article article, List<Link> links) {
