...
public class Article {
    ...
    public List<String> getParagraphsWithMentions() {
	if (paragraphsWithMentions == null)
	    return Collections.emptyList();
	return paragraphsWithMentions;
    }
    ...
    public void setParagraphsWithMentions(List<String> paragraphsWithMentions) {
	this.paragraphsWithMentions = paragraphsWithMentions;
    }
	...
	for (String p : getParagraphs())
	    sb.append("\t").append(p).append("\n");
	sb.append("PARAGRAPHs with Mentions:\n");
	for (String p : getParagraphsWithMentions())
	    sb.append("\t").append(p).append("\n");
	return sb.toString();
    }
